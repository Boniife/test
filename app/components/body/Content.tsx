...
const Content = () => {
  return (
    <div className='content'>
      ...
      <div className='content_txt2'>
        ...
        <div className='grid'>
          <div className='grid_1'>
            ...
            <br /><span className='font-[600]'>For 7.5% equity, you get a product manager, product designer, frontend engineer, software engineer and growth marketer to build the MVP of your app or web application and validate it.</span>
            </p>
            <h3>
              Learn More
            </h3>
          ...
          <div className='grid_1'>
            ...
            <br /><span className='font-[600]'>Raise $5k, $25k, $50k and $125k in 4 bootstrap deals within 12 months </span>
            </p>
            <h3>
              Learn More
            </h3>
      ...
      <div className='content_txt3'>
        <div className='container'>
          <div className='container_thead'>
            <h2>
            Our Area of Focus
            </h2>
            <p>
          ...
          <div className='container2'>
            <div className='container2_thead col'>
              <h4>
                01
              </h4>
              <p>
            ...
            <div className='container2_thead colo'>
              <h4>
                02
              </h4>
              <p>
            ...
            <div className='container2_thead colou'>
              <h4>
                03
              </h4>
              <p>
            ...
            <div className='container2_thead colour'>
              <h4>
                04
              </h4>
              <p>
            ...
            <div className='container2_thead colours'>
              <h4>
                05
              </h4>
              <p>
      ...
      <div className='content_txt4'>
        <div className='containe-head'>
          <h1>
        ...
        <div className='containe-down'>
          <div className='containe-down_body'>
            <h3>
            Service Incubator
            </h3>
            <p>
